...
void main() {
  testWidgets('MetroDynamicPage smoke test', (WidgetTester tester) async {
    // Build our app and trigger a frame.
    await tester.pumpWidget(const MyApp());

    // Verify that our stations and trains are displayed.
    expect(find.text('南港展覽館'), findsNWidgets(2));
    expect(find.text('動物園'), findsNWidgets(2));
  });
}
